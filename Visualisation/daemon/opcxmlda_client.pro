...
win32:LIBS        += $(CSOAPDIR)/win32/MinGW/libsoap.a
win32:LIBS        += $(LIBXML2DIR)/win32/bin.mingw/libxml2.a
win32:LIBS        += $(CSOAPDIR)/win32/MinGW/libnanohttp.a
win32:SOURCES     += $(CSOAPDIR)/nanohttp/nanohttp-logging.c
...
win32:INCLUDEPATH += $(LIBXML2DIR)/include
win32:INCLUDEPATH += $(CSOAPDIR)
